...
describe('mixColors', () => {
  it('mixes colors additively in RGB space', () => {
    ...
    const result = red.mixWith([green], {
      type: 'ADDITIVE',
      space: 'RGB',
    });
  ...
  it('mixes red, green, and blue additively to white', () => {
    ...
    const result = red.mixWith([green, blue], {
      type: 'ADDITIVE',
      space: 'RGB',
    });
  ...
  it('mixes colors subtractively in CMYK space', () => {
    ...
    const result = cyan.mixWith([yellow], { type: 'SUBTRACTIVE' });
  ...
  it('mixes cyan, magenta, and yellow subtractively to black', () => {
    ...
    const yellow = new Color('#ffff00');
    const result = cyan.mixWith([magenta, yellow], {
      type: 'SUBTRACTIVE',
    });
  ...
  it('accepts mixed case mix space', () => {
    ...
    const mix1 = c1.mixWith([c2], { space: 'RGB' });
    const mix2 = c1.mixWith([c2], { space: 'rgb' });
    // @ts-expect-error - testing mixed casing not covered by type but valid runtime
    const mix3 = c1.mixWith([c2], { space: 'rGb' });
  ...
  it('accepts mixed case mix type', () => {
    const c1 = new Color('red');
    const c2 = new Color('blue');
    const sub1 = c1.mixWith([c2], { type: 'SUBTRACTIVE' });
    const sub2 = c1.mixWith([c2], { type: 'subtractive' });
  ...
  it('mixes colors additively in Linear RGB space (brighter mix)', () => {
    ...
    const result = red.mixWith([green], { space: 'LINEAR_RGB', weights: [0.5, 0.5] });
  ...
  it('returns clone when no other colors are provided to mixWith', () => {
    const red = new Color('#ff0000');
    expect(red.mixWith([]).toHex()).toBe(red.toHex());
  });

  it('defaults weights to 1 when provided weights sum to 0', () => {
    const red = new Color('#ff0000');
    const blue = new Color('#0000ff');
    const result = red.mixWith([blue], { weights: [1, -1] });
  ...
  it('mixes colors with alpha channel in RGB space', () => {
    ...
    const result = semiRed.mixWith([blue], { type: 'ADDITIVE', space: 'RGB' });
  ...
  it('mixes colors in LCH space', () => {
    ...
    const result = black.mixWith([white], { space: 'LCH' });
  ...
  it('mixes colors in OKLCH space', () => {
    const black = new Color('#000000');
    const white = new Color('#ffffff');
    const result = black.mixWith([white], { space: 'OKLCH' });
  ...
  it('mixes colors across the red hue boundary using linear addition', () => {
    ...
    const result = h1.mixWith([h2], { space: 'HSL' });
  ...
  it('respects weights in additive mixing for polar spaces', () => {
    ...
    // R: 0.42 -> ~0.68 -> ~174
    // B: 0.21 -> ~0.50 -> ~128
    const result = darkRed.mixWith([darkBlue], {
      space: 'HSL',
      weights: [2, 1],
    });
  ...
  it('handles hue wrap-around in LCH space', () => {
    const h1 = new Color({ h: 350, s: 100, l: 50 });
    const h2 = new Color({ h: 10, s: 100, l: 50 });
    const result = h1.mixWith([h2], { space: 'LCH' });
  ...
  it('handles hue wrap-around in OKLCH space', () => {
    const h1 = new Color({ h: 350, s: 100, l: 50 });
    const h2 = new Color({ h: 10, s: 100, l: 50 });
    const result = h1.mixWith([h2], { space: 'OKLCH' });
  ...
  it('defaults to equal weights when weights length mismatches', () => {
    const red = new Color('#ff0000');
    const blue = new Color('#0000ff');
    const result = red.mixWith([blue], { weights: [2] });
    expect(result.toHex()).toBe('#bc00bc');
  });
  ...
  it('produces distinct results when mixing in HSL, LCH, and OKLCH spaces', () => {
    ...
    const hslMix = red.mixWith([cyan], { space: 'HSL' });
    const lchMix = red.mixWith([cyan], { space: 'LCH' });
    const oklchMix = red.mixWith([cyan], { space: 'OKLCH' });
  ...
  it('mixes colors subtractively in RGB space using normalized absorption', () => {
    const cyan = new Color('#00ffff');
    const yellow = new Color('#ffff00');
    const result = cyan.mixWith([yellow], { type: 'SUBTRACTIVE', space: 'RGB' });
  ...
  it('mixes colors subtractively in Linear RGB space and respects weight ratios', () => {
    const green = new Color('#00ff00');
    const blue = new Color('#0000ff');
    const mixA = green.mixWith([blue], {
      type: 'SUBTRACTIVE',
      space: 'LINEAR_RGB',
      weights: [2, 1],
    });
    const mixB = green.mixWith([blue], {
      type: 'SUBTRACTIVE',
      space: 'LINEAR_RGB',
      weights: [200, 100],
    });
  ...
  it('mixes colors subtractively in HSL space while handling hue wrap-around', () => {
    const h1 = new Color({ h: 350, s: 100, l: 50 });
    const h2 = new Color({ h: 10, s: 100, l: 50 });
    const result = h1.mixWith([h2], { type: 'SUBTRACTIVE', space: 'HSL' });
  ...
  it('mixes colors subtractively in LCH space with chroma-driven hue', () => {
    const red = new Color('#ff0000');
    const blue = new Color('#0000ff');
    const result = red.mixWith([blue], { type: 'SUBTRACTIVE', space: 'LCH' });
  ...
  it('mixes colors subtractively in OKLCH space with clamped lightness', () => {
    const black = new Color('#000000');
    const white = new Color('#ffffff');
    const result = black.mixWith([white], { type: 'SUBTRACTIVE', space: 'OKLCH' });
  ...
  it('handles alpha when mixing subtractively', () => {
    ...
    const result = yellow.mixWith([magenta], { type: 'SUBTRACTIVE', space: 'RGB' });
...
describe('averageColors', () => {
  it('averages colors in RGB space', () => {
    const red = new Color('#ff0000');
    const blue = new Color('#0000ff');
    const result = red.averageWith([blue], { space: 'RGB' });
  ...
  it('averages colors in Linear RGB space (brighter purple)', () => {
    const red = new Color('#ff0000');
    const blue = new Color('#0000ff');
    const result = red.averageWith([blue], { space: 'LINEAR_RGB' });
  ...
  it('averages red, green, and blue to gray in RGB space', () => {
    ...
    const green = new Color('#00ff00');
    const blue = new Color('#0000ff');
    const result = red.averageWith([green, blue], { space: 'RGB' });
  ...
  it('averages colors in HSL space with weights', () => {
    const red = new Color('#ff0000');
    const green = new Color('#00ff00');
    const result = red.averageWith([green], {
      space: 'HSL',
      weights: [1, 2],
    });
  ...
  it('defaults to Linear RGB averaging', () => {
    const red = new Color('#ff0000');
    const green = new Color('#00ff00');
    const result = red.averageWith([green], undefined);
  ...
  it('returns clone when no other colors are provided to mixWith', () => {
    const red = new Color('#ff0000');
    expect(red.averageWith([]).toHex()).toBe(red.toHex());
  });

  it('averages colors with alpha channel', () => {
    const semiRed = new Color({ r: 255, g: 0, b: 0, a: 0.5 });
    const blue = new Color({ r: 0, g: 0, b: 255, a: 1 });
    const result = semiRed.averageWith([blue], { space: 'RGB' });
    expect(result.toHex()).toBe('#800080');
    expect(result.toRGBA().a).toBe(0.75);
  });
  ...
  it('averages black and white in LCH space', () => {
    const black = new Color('#000000');
    const white = new Color('#ffffff');
    const result = black.averageWith([white], { space: 'LCH' });
    expect(result.toHex()).toBe('#777777');
  });
  ...
  it('averages black and white in OKLCH space', () => {
    const black = new Color('#000000');
    const white = new Color('#ffffff');
    const result = black.averageWith([white], { space: 'OKLCH' });
    expect(result.toHex()).toBe('#636363');
  });
  ...
  it('averages hues correctly across the 360° boundary', () => {
    const h1 = new Color({ h: 350, s: 100, l: 50 });
    const h2 = new Color({ h: 10, s: 100, l: 50 });
    const result = h1.averageWith([h2], { space: 'HSL' });
  ...
  it('minimizes saturation when averaging opposing low-saturation hues in HSL space', () => {
    ...
    const result = warmGray.averageWith([coolGray], { space: 'HSL' });
    const hsl = result.toHSL();
  ...
  it('averages LCH hues correctly across 360 boundary', () => {
    ...
    const result = h1.averageWith([h2], { space: 'LCH' });
  ...
  it('averages OKLCH hues correctly across 360 boundary', () => {
    ...
    const result = h1.averageWith([h2], { space: 'OKLCH' });
  ...
  it('keeps hue stable when chroma is negligible in LCH space', () => {
    ...
    const result = saturated.averageWith([desaturatedOpponent], { space: 'LCH' });
    const lch = result.toLCH();
  ...
  it('keeps hue stable when chroma is negligible in OKLCH space', () => {
    ...
    const result = saturated.averageWith([desaturatedOpponent], { space: 'OKLCH' });
    const oklch = result.toOKLCH();
  ...
  it('preserves alpha when averaging in HSL, LCH, and OKLCH spaces', () => {
    ...
    const hslAverage = translucentRed.averageWith([translucentBlue], { space: 'HSL' });
    const lchAverage = translucentRed.averageWith([translucentBlue], { space: 'LCH' });
    const oklchAverage = translucentRed.averageWith([translucentBlue], { space: 'OKLCH' });
  ...
  it('averages alpha across all spaces using normalized weights', () => {
    ...
    const rgb = lowAlphaRed.averageWith([opaqueBlue], { space: 'RGB', weights });
    const linearRgb = lowAlphaRed.averageWith([opaqueBlue], { space: 'LINEAR_RGB', weights });
    const hsl = lowAlphaRed.averageWith([opaqueBlue], { space: 'HSL', weights });
    const lch = lowAlphaRed.averageWith([opaqueBlue], { space: 'LCH', weights });
    const oklch = lowAlphaRed.averageWith([opaqueBlue], { space: 'OKLCH', weights });
  ...
  it('defaults to equal weights when weights length mismatches', () => {
    const red = new Color('#ff0000');
    const blue = new Color('#0000ff');
    const result = red.averageWith([blue], { weights: [2] });
    expect(result.toHex()).toBe('#bc00bc');
  });
  ...
  it('defaults weights to equal when provided weights sum to 0', () => {
    const red = new Color('#ff0000');
    const blue = new Color('#0000ff');
    const result = red.averageWith([blue], { weights: [1, -1] });
    expect(result.toHex()).toBe('#bc00bc');
  });
});
...
describe('blendColors', () => {
  it('blends using multiply mode', () => {
    const red = new Color('#ff0000');
    const blue = new Color('#0000ff');
    const result = red.blendWith(blue, { mode: 'MULTIPLY', ratio: 1 });
    expect(result.toHex()).toBe('#000000');
  });
  ...
  it('accepts mixed case blend mode', () => {
    const c1 = new Color('red');
    const c2 = new Color('blue');
    const b1 = c1.blendWith(c2, { mode: 'MULTIPLY' });
    const b2 = c1.blendWith(c2, { mode: 'multiply' });
  ...
  it('accepts mixed case blend space', () => {
    const c1 = new Color('red');
    const c2 = new Color('blue');
    const b1 = c1.blendWith(c2, { space: 'HSL' });
    const b2 = c1.blendWith(c2, { space: 'hsl' });
  ...
  it('partially blends using multiply mode', () => {
    const red = new Color('#ff0000');
    const blue = new Color('#0000ff');
    const result = red.blendWith(blue, {
      mode: 'MULTIPLY',
      ratio: 0.5,
    });
    expect(result.toHex()).toBe('#800000');
  ...
  it('blends using screen mode', () => {
    const red = new Color('#ff0000');
    const blue = new Color('#0000ff');
    const result = red.blendWith(blue, { mode: 'SCREEN', ratio: 1 });
    expect(result.toHex()).toBe('#ff00ff');
  });
  ...
  it('blends using overlay mode', () => {
    ...
    const white = new Color('#ffffff');
    const result = gray.blendWith(white, { mode: 'OVERLAY', ratio: 1 });
    expect(result.toHex()).toBe('#ffffff');
  });
  ...
  it('returns base color when ratio is 0', () => {
    const red = new Color('#ff0000');
    const blue = new Color('#0000ff');
    const result = red.blendWith(blue, { ratio: 0 });
    expect(result.toHex()).toBe('#ff0000');
  });
  ...
  it('returns blend color when ratio is 1 in normal mode', () => {
    const red = new Color('#ff0000');
    const blue = new Color('#0000ff');
    const result = red.blendWith(blue, { mode: 'NORMAL', ratio: 1 });
    expect(result.toHex()).toBe('#0000ff');
  });
  ...
  it('clamps ratio outside of range 0-1', () => {
    const red = new Color('#ff0000');
    const blue = new Color('#0000ff');
    expect(red.blendWith(blue, { ratio: -1 }).toHex()).toBe('#ff0000');
    expect(red.blendWith(blue, { ratio: 2 }).toHex()).toBe('#0000ff');
  });

  it('blends colors with alpha channel in RGB space', () => {
    const semiRed = new Color({ r: 255, g: 0, b: 0, a: 0.5 });
    const blue = new Color({ r: 0, g: 0, b: 255, a: 0.2 });
    const result = semiRed.blendWith(blue, { ratio: 0.5 });
    expect(result.toHex()).toBe('#800080');
  ...
  it('handles hue wrap-around when blending in HSL space', () => {
    const h1 = new Color({ h: 350, s: 100, l: 50 });
    const h2 = new Color({ h: 10, s: 100, l: 50 });
    const result = h1.blendWith(h2, { space: 'HSL', ratio: 0.5 });
    expect(result.toHex()).toBe('#ff0000');
  });
  ...
  it('blends using overlay mode with dark base color', () => {
    ...
    const red = new Color('#ff0000');
    const result = darkGray.blendWith(red, { mode: 'OVERLAY', ratio: 1 });
    expect(result.toHex()).toBe('#800000');
  });
  ...
  it('applies blend modes within HSL space', () => {
    const red = new Color('#ff0000');
    const blue = new Color('#0000ff');
    const normal = red.blendWith(blue, { space: 'HSL', mode: 'NORMAL', ratio: 0.5 });
    const multiply = red.blendWith(blue, { space: 'HSL', mode: 'MULTIPLY', ratio: 0.5 });
    const screen = red.blendWith(blue, { space: 'HSL', mode: 'SCREEN', ratio: 0.5 });
    const overlay = red.blendWith(blue, { space: 'HSL', mode: 'OVERLAY', ratio: 0.5 });
  ...
  it('handles hue wrap-around for multiple HSL blend modes', () => {
    const h1 = new Color({ h: 350, s: 100, l: 50 });
    const h2 = new Color({ h: 10, s: 100, l: 50 });
    const multiply = h1.blendWith(h2, { space: 'HSL', mode: 'MULTIPLY', ratio: 0.5 });
    const screen = h1.blendWith(h2, { space: 'HSL', mode: 'SCREEN', ratio: 0.5 });
    const overlay = h1.blendWith(h2, { space: 'HSL', mode: 'OVERLAY', ratio: 0.5 });
  ...
  it('preserves alpha handling when blending in HSL space', () => {
    const semiRed = new Color({ r: 255, g: 0, b: 0, a: 0.5 });
    const blue = new Color({ r: 0, g: 0, b: 255, a: 0.2 });
    const result = semiRed.blendWith(blue, { space: 'HSL', mode: 'MULTIPLY', ratio: 0.5 });
...
describe('LINEAR_RGB robustness', () => {
  it('produces physically accurate middle gray from black and white', () => {
    const black = new Color('#000000');
    const white = new Color('#ffffff');
    const result = black.averageWith([white], { space: 'LINEAR_RGB' });
  ...
  it('mixes blue and yellow to a lighter gray than sRGB', () => {
    ...
    const srgbResult = blue.averageWith([yellow], { space: 'RGB' });
    expect(srgbResult.toHex()).toBe('#808080'); // Dark gray

    const linearResult = blue.averageWith([yellow], { space: 'LINEAR_RGB' });
  ...
  it('uses linear light addition for channels when mixing additively', () => {
    ...
    const srgbMix = red.mixWith([green], { space: 'RGB', weights: [0.5, 0.5] });
    const linearMix = red.mixWith([green], { space: 'LINEAR_RGB', weights: [0.5, 0.5] });
  ...
  it('handles alpha blending linearly', () => {
    ...
    const result = transparentRed.averageWith([opaqueGreen], { space: 'LINEAR_RGB' });
  ...
  it('verifies that many random colors mix to brighter values in Linear than sRGB', () => {
    ...
    for (let i = 0; i < 20; i++) {
      ...
      const linear = c1.averageWith([c2], { space: 'LINEAR_RGB' });
      const srgb = c1.averageWith([c2], { space: 'RGB' });
  ...
  it('throws for invalid mix option values', () => {
    ...
    expect(() => red.mixWith([blue], { type: 'INVALID' as never })).toThrow("Invalid 'type'");
    expect(() => red.mixWith([blue], { space: 'INVALID' as never })).toThrow("Invalid 'space'");
  });
  ...
  it('throws for invalid blend option values', () => {
    ...
    expect(() => red.blendWith(blue, { mode: 'INVALID' as never })).toThrow("Invalid 'mode'");
    expect(() => red.blendWith(blue, { space: 'INVALID' as never })).toThrow("Invalid 'space'");
  });
  ...
  it('throws for invalid average option values', () => {
    ...
    expect(() => red.averageWith([blue], { space: 'INVALID' as never })).toThrow("Invalid 'space'");
  });
});
