...
function mixColorsWrapped(colors: readonly Color[], options?: MixColorsOptions) {
  return new Color(
    mixColors(
      colors.map((c) => c.toRGBA()),
      options,
    ),
  );
}

function averageColorsWrapped(colors: readonly Color[], options?: AverageColorsOptions) {
  return new Color(
    averageColors(
      colors.map((c) => c.toRGBA()),
      options,
...
function blendColorsWrapped(base: Color, blend: Color, options?: BlendColorsOptions) {
  return new Color(blendColors(base.toRGBA(), blend.toRGBA(), options));
}
...
describe('mixColors', () => {
  it('mixes colors additively in RGB space', () => {
    ...
    const result = mixColorsWrapped([red, green], {
      type: 'ADDITIVE',
      space: 'RGB',
    });
  ...
  it('mixes red, green, and blue additively to white', () => {
    ...
    const result = mixColorsWrapped([red, green, blue], {
      type: 'ADDITIVE',
      space: 'RGB',
    });
  ...
  it('mixes colors subtractively in CMYK space', () => {
    ...
    const result = mixColorsWrapped([cyan, yellow], { type: 'SUBTRACTIVE' });
  ...
  it('mixes cyan, magenta, and yellow subtractively to black', () => {
    ...
    const yellow = new Color('#ffff00');
    const result = mixColorsWrapped([cyan, magenta, yellow], {
      type: 'SUBTRACTIVE',
    });
  ...
  it('mixes colors in HSL space with weighted interpolation', () => {
    const red = new Color('#ff0000');
    const blue = new Color('#0000ff');
    const result = mixColorsWrapped([red, blue], {
      space: 'HSL',
      weights: [1, 3],
    });
  ...
  it('accepts mixed case mix space', () => {
    ...
    const mix1 = mixColorsWrapped([c1, c2], { space: 'RGB' });
    const mix2 = mixColorsWrapped([c1, c2], { space: 'rgb' });
    // @ts-expect-error - testing mixed casing not covered by type but valid runtime
    const mix3 = mixColorsWrapped([c1, c2], { space: 'rGb' });
  ...
  it('accepts mixed case mix type', () => {
    const c1 = new Color('red');
    const c2 = new Color('blue');
    const sub1 = mixColorsWrapped([c1, c2], { type: 'SUBTRACTIVE' });
    const sub2 = mixColorsWrapped([c1, c2], { type: 'subtractive' });
  ...
  it('mixes colors additively in Linear RGB space (brighter mix)', () => {
    ...
    const result = mixColorsWrapped([red, green], { space: 'LINEAR_RGB', weights: [0.5, 0.5] });
  ...
  it('throws when fewer than two colors are provided', () => {
    const red = new Color('#ff0000');
    expect(() => mixColorsWrapped([red], undefined)).toThrow(
  ...
  it('defaults weights to 1 when provided weights sum to 0', () => {
    const red = new Color('#ff0000');
    const blue = new Color('#0000ff');
    const result = mixColorsWrapped([red, blue], { weights: [1, -1] });
  ...
  it('mixes colors with alpha channel in RGB space', () => {
    ...
    const result = mixColorsWrapped([semiRed, blue], { type: 'ADDITIVE', space: 'RGB' });
  ...
  it('mixes colors in LCH space', () => {
    ...
    const result = mixColorsWrapped([black, white], { space: 'LCH' });
  ...
  it('mixes colors in OKLCH space', () => {
    const black = new Color('#000000');
    const white = new Color('#ffffff');
    const result = mixColorsWrapped([black, white], { space: 'OKLCH' });
  ...
  it('mixes colors across the red hue boundary using linear addition', () => {
    ...
    const result = mixColorsWrapped([h1, h2], { space: 'HSL' });
  ...
  it('respects weights in additive mixing for polar spaces', () => {
    ...
    // R: 0.42 -> ~0.68 -> ~174
    // B: 0.21 -> ~0.50 -> ~128
    const result = mixColorsWrapped([darkRed, darkBlue], {
      space: 'HSL',
      weights: [2, 1],
    });
  ...
  it('handles hue wrap-around in LCH space', () => {
    const h1 = new Color({ h: 350, s: 100, l: 50 });
    const h2 = new Color({ h: 10, s: 100, l: 50 });
    const result = mixColorsWrapped([h1, h2], { space: 'LCH' });
  ...
  it('handles hue wrap-around in OKLCH space', () => {
    const h1 = new Color({ h: 350, s: 100, l: 50 });
    const h2 = new Color({ h: 10, s: 100, l: 50 });
    const result = mixColorsWrapped([h1, h2], { space: 'OKLCH' });
  ...
  it('defaults to equal weights when weights length mismatches', () => {
    const red = new Color('#ff0000');
    const blue = new Color('#0000ff');
    const result = mixColorsWrapped([red, blue], { weights: [2] });
    expect(result.toHex()).toBe('#bc00bc');
  });
  ...
  it('ignores colors with zero weight', () => {
    const red = new Color('#ff0000');
    const blue = new Color('#0000ff');
    const result = mixColorsWrapped([red, blue], { weights: [0, 1] });
    expect(result.toHex()).toBe('#0000ff');
  });

  it('accumulates light when mixing identical colors in HSL space', () => {
    const darkRed = new Color('#800000');
    const result = mixColorsWrapped([darkRed, darkRed], { space: 'HSL' });
  ...
  it('produces distinct results when mixing in HSL, LCH, and OKLCH spaces', () => {
    ...
    const hslMix = mixColorsWrapped([red, cyan], { space: 'HSL' });
    const lchMix = mixColorsWrapped([red, cyan], { space: 'LCH' });
    const oklchMix = mixColorsWrapped([red, cyan], { space: 'OKLCH' });
  ...
  it('mixes colors subtractively in RGB space using normalized absorption', () => {
    const cyan = new Color('#00ffff');
    const yellow = new Color('#ffff00');
    const result = mixColorsWrapped([cyan, yellow], { type: 'SUBTRACTIVE', space: 'RGB' });
  ...
  it('mixes colors subtractively in Linear RGB space and respects weight ratios', () => {
    const green = new Color('#00ff00');
    const blue = new Color('#0000ff');
    const mixA = mixColorsWrapped([green, blue], {
      type: 'SUBTRACTIVE',
      space: 'LINEAR_RGB',
      weights: [2, 1],
    });
    const mixB = mixColorsWrapped([green, blue], {
      type: 'SUBTRACTIVE',
      space: 'LINEAR_RGB',
      weights: [200, 100],
    });
  ...
  it('mixes colors subtractively in HSL space while handling hue wrap-around', () => {
    const h1 = new Color({ h: 350, s: 100, l: 50 });
    const h2 = new Color({ h: 10, s: 100, l: 50 });
    const result = mixColorsWrapped([h1, h2], { type: 'SUBTRACTIVE', space: 'HSL' });
  ...
  it('mixes colors subtractively in LCH space with chroma-driven hue', () => {
    const red = new Color('#ff0000');
    const blue = new Color('#0000ff');
    const result = mixColorsWrapped([red, blue], { type: 'SUBTRACTIVE', space: 'LCH' });
  ...
  it('mixes colors subtractively in OKLCH space with clamped lightness', () => {
    const black = new Color('#000000');
    const white = new Color('#ffffff');
    const result = mixColorsWrapped([black, white], { type: 'SUBTRACTIVE', space: 'OKLCH' });
  ...
  it('handles alpha when mixing subtractively', () => {
    ...
    const result = mixColorsWrapped([yellow, magenta], { type: 'SUBTRACTIVE', space: 'RGB' });
...
describe('averageColors', () => {
  it('averages colors in RGB space', () => {
    const red = new Color('#ff0000');
    const blue = new Color('#0000ff');
    const result = averageColorsWrapped([red, blue], { space: 'RGB' });
  ...
  it('averages colors in Linear RGB space (brighter purple)', () => {
    const red = new Color('#ff0000');
    const blue = new Color('#0000ff');
    const result = averageColorsWrapped([red, blue], { space: 'LINEAR_RGB' });
  ...
  it('averages red, green, and blue to gray in RGB space', () => {
    ...
    const green = new Color('#00ff00');
    const blue = new Color('#0000ff');
    const result = averageColorsWrapped([red, green, blue], { space: 'RGB' });
  ...
  it('averages colors in HSL space with weights', () => {
    const red = new Color('#ff0000');
    const green = new Color('#00ff00');
    const result = averageColorsWrapped([red, green], {
      space: 'HSL',
      weights: [1, 2],
    });
  ...
  it('defaults to Linear RGB averaging', () => {
    const red = new Color('#ff0000');
    const green = new Color('#00ff00');
    const result = averageColorsWrapped([red, green], undefined);
  ...
  it('throws when fewer than two colors are provided', () => {
    const red = new Color('#ff0000');
    expect(() => averageColorsWrapped([red], {})).toThrow(
  ...
  it('averages colors with alpha channel', () => {
    const semiRed = new Color({ r: 255, g: 0, b: 0, a: 0.5 });
    const blue = new Color({ r: 0, g: 0, b: 255, a: 1 });
    const result = averageColorsWrapped([semiRed, blue], { space: 'RGB' });
    expect(result.toHex()).toBe('#800080');
    expect(result.toRGBA().a).toBe(0.75);
  });
  ...
  it('averages black and white in LCH space', () => {
    const black = new Color('#000000');
    const white = new Color('#ffffff');
    const result = averageColorsWrapped([black, white], { space: 'LCH' });
    expect(result.toHex()).toBe('#777777');
  });
  ...
  it('averages black and white in OKLCH space', () => {
    const black = new Color('#000000');
    const white = new Color('#ffffff');
    const result = averageColorsWrapped([black, white], { space: 'OKLCH' });
    expect(result.toHex()).toBe('#636363');
  });
  ...
  it('averages hues correctly across the 360° boundary', () => {
    const h1 = new Color({ h: 350, s: 100, l: 50 });
    const h2 = new Color({ h: 10, s: 100, l: 50 });
    const result = averageColorsWrapped([h1, h2], { space: 'HSL' });
  ...
  it('minimizes saturation when averaging opposing low-saturation hues in HSL space', () => {
    ...
    const result = averageColorsWrapped([warmGray, coolGray], { space: 'HSL' });
    const hsl = result.toHSL();
  ...
  it('averages LCH hues correctly across 360 boundary', () => {
    ...
    const result = averageColorsWrapped([h1, h2], { space: 'LCH' });
  ...
  it('averages OKLCH hues correctly across 360 boundary', () => {
    ...
    const result = averageColorsWrapped([h1, h2], { space: 'OKLCH' });
  ...
  it('keeps hue stable when chroma is negligible in LCH space', () => {
    ...
    const result = averageColorsWrapped([saturated, desaturatedOpponent], { space: 'LCH' });
    const lch = result.toLCH();
  ...
  it('keeps hue stable when chroma is negligible in OKLCH space', () => {
    ...
    const result = averageColorsWrapped([saturated, desaturatedOpponent], { space: 'OKLCH' });
    const oklch = result.toOKLCH();
  ...
  it('preserves alpha when averaging in HSL, LCH, and OKLCH spaces', () => {
    ...
    const hslAverage = averageColorsWrapped([translucentRed, translucentBlue], { space: 'HSL' });
    const lchAverage = averageColorsWrapped([translucentRed, translucentBlue], { space: 'LCH' });
    const oklchAverage = averageColorsWrapped([translucentRed, translucentBlue], {
      space: 'OKLCH',
    });
  ...
  it('averages alpha across all spaces using normalized weights', () => {
    ...
    const rgb = averageColorsWrapped([lowAlphaRed, opaqueBlue], { space: 'RGB', weights });
    const linearRgb = averageColorsWrapped([lowAlphaRed, opaqueBlue], {
      space: 'LINEAR_RGB',
      weights,
    });
    const hsl = averageColorsWrapped([lowAlphaRed, opaqueBlue], { space: 'HSL', weights });
    const lch = averageColorsWrapped([lowAlphaRed, opaqueBlue], { space: 'LCH', weights });
    const oklch = averageColorsWrapped([lowAlphaRed, opaqueBlue], { space: 'OKLCH', weights });
  ...
  it('defaults to equal weights when weights length mismatches', () => {
    const red = new Color('#ff0000');
    const blue = new Color('#0000ff');
    const result = averageColorsWrapped([red, blue], { weights: [2] });
    expect(result.toHex()).toBe('#bc00bc');
  });
  ...
  it('defaults weights to equal when provided weights sum to 0', () => {
    const red = new Color('#ff0000');
    const blue = new Color('#0000ff');
    const result = averageColorsWrapped([red, blue], { weights: [1, -1] });
    expect(result.toHex()).toBe('#bc00bc');
  });
});
...
describe('blendColors', () => {
  it('blends using multiply mode', () => {
    const red = new Color('#ff0000');
    const blue = new Color('#0000ff');
    const result = blendColorsWrapped(red, blue, { mode: 'MULTIPLY', ratio: 1 });
    expect(result.toHex()).toBe('#000000');
  });
  ...
  it('accepts mixed case blend mode', () => {
    const c1 = new Color('red');
    const c2 = new Color('blue');
    const b1 = blendColorsWrapped(c1, c2, { mode: 'MULTIPLY' });
    const b2 = blendColorsWrapped(c1, c2, { mode: 'multiply' });
  ...
  it('accepts mixed case blend space', () => {
    const c1 = new Color('red');
    const c2 = new Color('blue');
    const b1 = blendColorsWrapped(c1, c2, { space: 'HSL' });
    const b2 = blendColorsWrapped(c1, c2, { space: 'hsl' });
  ...
  it('partially blends using multiply mode', () => {
    const red = new Color('#ff0000');
    const blue = new Color('#0000ff');
    const result = blendColorsWrapped(red, blue, {
      mode: 'MULTIPLY',
      ratio: 0.5,
    });
    expect(result.toHex()).toBe('#800000');
  ...
  it('blends using screen mode', () => {
    const red = new Color('#ff0000');
    const blue = new Color('#0000ff');
    const result = blendColorsWrapped(red, blue, { mode: 'SCREEN', ratio: 1 });
    expect(result.toHex()).toBe('#ff00ff');
  });
  ...
  it('blends using overlay mode', () => {
    ...
    const white = new Color('#ffffff');
    const result = blendColorsWrapped(gray, white, { mode: 'OVERLAY', ratio: 1 });
    expect(result.toHex()).toBe('#ffffff');
  });
  ...
  it('returns base color when ratio is 0', () => {
    const red = new Color('#ff0000');
    const blue = new Color('#0000ff');
    const result = blendColorsWrapped(red, blue, { ratio: 0 });
    expect(result.toHex()).toBe('#ff0000');
  });
  ...
  it('returns blend color when ratio is 1 in normal mode', () => {
    const red = new Color('#ff0000');
    const blue = new Color('#0000ff');
    const result = blendColorsWrapped(red, blue, { mode: 'NORMAL', ratio: 1 });
    expect(result.toHex()).toBe('#0000ff');
  });
  ...
  it('clamps ratio outside of range 0-1', () => {
    const red = new Color('#ff0000');
    const blue = new Color('#0000ff');
    expect(blendColorsWrapped(red, blue, { ratio: -1 }).toHex()).toBe('#ff0000');
    expect(blendColorsWrapped(red, blue, { ratio: 2 }).toHex()).toBe('#0000ff');
  });

  it('blends colors with alpha channel in RGB space', () => {
    const semiRed = new Color({ r: 255, g: 0, b: 0, a: 0.5 });
    const blue = new Color({ r: 0, g: 0, b: 255, a: 0.2 });
    const result = blendColorsWrapped(semiRed, blue, { ratio: 0.5 });
    expect(result.toHex()).toBe('#800080');
  ...
  it('handles hue wrap-around when blending in HSL space', () => {
    const h1 = new Color({ h: 350, s: 100, l: 50 });
    const h2 = new Color({ h: 10, s: 100, l: 50 });
    const result = blendColorsWrapped(h1, h2, { space: 'HSL', ratio: 0.5 });
    expect(result.toHex()).toBe('#ff0000');
  });
  ...
  it('blends using overlay mode with dark base color', () => {
    ...
    const red = new Color('#ff0000');
    const result = blendColorsWrapped(darkGray, red, { mode: 'OVERLAY', ratio: 1 });
    expect(result.toHex()).toBe('#800000');
  });
  ...
  it('applies blend modes within HSL space', () => {
    const red = new Color('#ff0000');
    const blue = new Color('#0000ff');
    const normal = blendColorsWrapped(red, blue, { space: 'HSL', mode: 'NORMAL', ratio: 0.5 });
    const multiply = blendColorsWrapped(red, blue, { space: 'HSL', mode: 'MULTIPLY', ratio: 0.5 });
    const screen = blendColorsWrapped(red, blue, { space: 'HSL', mode: 'SCREEN', ratio: 0.5 });
    const overlay = blendColorsWrapped(red, blue, { space: 'HSL', mode: 'OVERLAY', ratio: 0.5 });
  ...
  it('handles hue wrap-around for multiple HSL blend modes', () => {
    const h1 = new Color({ h: 350, s: 100, l: 50 });
    const h2 = new Color({ h: 10, s: 100, l: 50 });
    const multiply = blendColorsWrapped(h1, h2, { space: 'HSL', mode: 'MULTIPLY', ratio: 0.5 });
    const screen = blendColorsWrapped(h1, h2, { space: 'HSL', mode: 'SCREEN', ratio: 0.5 });
    const overlay = blendColorsWrapped(h1, h2, { space: 'HSL', mode: 'OVERLAY', ratio: 0.5 });
  ...
  it('preserves alpha handling when blending in HSL space', () => {
    const semiRed = new Color({ r: 255, g: 0, b: 0, a: 0.5 });
    const blue = new Color({ r: 0, g: 0, b: 255, a: 0.2 });
    const result = blendColorsWrapped(semiRed, blue, {
      space: 'HSL',
      mode: 'MULTIPLY',
      ratio: 0.5,
    });
...
describe('LINEAR_RGB robustness', () => {
  it('produces physically accurate middle gray from black and white', () => {
    const black = new Color('#000000');
    const white = new Color('#ffffff');
    const result = averageColorsWrapped([black, white], { space: 'LINEAR_RGB' });
  ...
  it('mixes blue and yellow to a lighter gray than sRGB', () => {
    ...
    const srgbResult = averageColorsWrapped([blue, yellow], { space: 'RGB' });
    expect(srgbResult.toHex()).toBe('#808080'); // Dark gray

    const linearResult = averageColorsWrapped([blue, yellow], { space: 'LINEAR_RGB' });
  ...
  it('uses linear light addition for channels when mixing additively', () => {
    ...
    const srgbMix = mixColorsWrapped([red, green], { space: 'RGB', weights: [0.5, 0.5] });
    const linearMix = mixColorsWrapped([red, green], { space: 'LINEAR_RGB', weights: [0.5, 0.5] });
  ...
  it('handles alpha blending linearly', () => {
    ...
    const result = averageColorsWrapped([transparentRed, opaqueGreen], { space: 'LINEAR_RGB' });
  ...
  it('verifies that many random colors mix to brighter values in Linear than sRGB', () => {
    ...
    for (let i = 0; i < 20; i++) {
      ...
      const linear = averageColorsWrapped([c1, c2], { space: 'LINEAR_RGB' });
      const srgb = averageColorsWrapped([c1, c2], { space: 'RGB' });
  ...
  it('throws for invalid mix option values', () => {
    ...
    expect(() => mixColorsWrapped([red, blue], { type: 'INVALID' as never })).toThrow(
      "Invalid 'type'",
    );
    expect(() => mixColorsWrapped([red, blue], { space: 'INVALID' as never })).toThrow(
      "Invalid 'space'",
    );
  });
  ...
  it('throws for invalid blend option values', () => {
    ...
    expect(() => blendColorsWrapped(red, blue, { mode: 'INVALID' as never })).toThrow(
      "Invalid 'mode'",
    );
    expect(() => blendColorsWrapped(red, blue, { space: 'INVALID' as never })).toThrow(
      "Invalid 'space'",
    );
  });
  ...
  it('throws for invalid average option values', () => {
    ...
    expect(() => averageColorsWrapped([red, blue], { space: 'INVALID' as never })).toThrow(
      "Invalid 'space'",
    );
  });
});
